...
/*   Updated: 2023/03/15 19:40:12 by ranki            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_rrotate_b(t_list **b, t_listopt **result, t_all *all)
{
	...
	prec->next = NULL;
	add_move(result, "rrb", all);
}

void	ft_rrotate_rr(t_list **a, t_list **b, t_listopt **result, t_all *all)
{
	t_list	*tmp;
	t_list	*prec;
